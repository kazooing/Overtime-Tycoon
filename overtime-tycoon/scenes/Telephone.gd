...
func _process(delta: float) -> void:
	...
	if pressed:
		ease_vector = square_ease(global_position, mouse_pos)
		...
		ease_vector = 0.3 * square_ease(global_position, start_pos)
...
func square_ease(pos1: Vector2, pos2: Vector2) -> Vector2:
